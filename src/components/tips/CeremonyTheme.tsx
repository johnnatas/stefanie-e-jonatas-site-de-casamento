  ...
  return (
    <div>
      <div className="flex flex-col items-center gap-10 lg:grid lg:grid-cols-2 lg:items-center lg:gap-16">
        <div className="relative h-64 w-full max-w-xl overflow-hidden rounded-lg border border-line lg:h-96 lg:max-w-none">
          <PhotoOrPlaceholder
            src={content.photo}
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          ...
          {infoLines.length > 0 && (
            <>
              ...
              <div className="mt-6 flex flex-col items-center gap-1 text-center font-sans text-sm uppercase tracking-widest text-forest lg:items-start lg:text-left">
