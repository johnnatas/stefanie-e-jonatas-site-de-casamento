...
- **Névoa** (`#ffffff`): branco puro, uso único na seção "Save the date" da Home — quebra deliberada tanto do verde-sálvia quanto da regra do papel quente, para dar respiro visual entre o hero e o restante da página.
